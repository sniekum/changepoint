...
if __name__ == '__main__':
    ...
    #stapler ex3: traj=2, sigmas=0.02, pi/30, penalty=100, min=20 OR No penalty, but 1000/50 gauss time
    ...
    #table ex3: traj=1, sigmas=0.02, pi/30, penalty=100, min=20, thresh=0.15 or .12 for traj2
